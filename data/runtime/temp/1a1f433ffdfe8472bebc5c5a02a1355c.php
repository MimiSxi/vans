<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:60:"./application/admin/template/recycle_bin\gbookattr_index.htm";i:1573115083;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:82:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\recycle_bin\bar.htm";i:1571728724;s:82:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\recycle_bin\btn.htm";i:1583461444;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form id="search_form" class="navbar-form form-inline" action="<?php echo url('RecycleBin/gbookattr_index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
...
<div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
    <input type="button" class="btn <?php if(\think\Request::instance()->action() != 'gbookattr_index'): ?>current<?php else: ?>selected<?php endif; ?>" value="留言属性" onClick="window.location.href='<?php echo url('RecycleBin/gbookattr_index'); ?>';">
                    ...
                    <!-- <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo url('RecycleBin/gbookattr_index'); ?>';">
                    </div> -->
                </div>
            </form>
        </div>
                ...
                <table cellspacing="0" cellpadding="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th abbr="article_title" axis="col3" class="">
                            <div style="text-align: left; padding-left: 10px;" class="">表单名称</div>
                        </th>
                ...
                <table style="width: 100%;">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="">
                                <div class="w150 tc"><a href="<?php echo url('RecycleBin/gbookattr_index', array('typeid'=>$vo['typeid'])); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="w100 tc">
                            ...
                            <td class="">
                                <div class="w150 tc">
                                    <?php if(is_check_access('RecycleBin@gbookattr_recovery') == '1'): ?>
                                    <a class="btn blue" href="javascript:void(0);" data-url="<?php echo url('RecycleBin/gbookattr_recovery'); ?>" data-id="<?php echo $vo['attr_id']; ?>" data-attr_name="<?php echo $vo['attr_name']; ?>" onClick="recovery(this);"><i class="fa fa-trash-o"></i>还原</a>
                                    <?php endif; if(is_check_access('RecycleBin@gbookattr_del') == '1'): ?>
                                    <a class="btn red" href="javascript:void(0);" data-url="<?php echo url('RecycleBin/gbookattr_del'); ?>" data-id="<?php echo $vo['attr_id']; ?>" data-attr_name="<?php echo $vo['attr_name']; ?>" onClick="delfun(this);"><i class="fa fa-trash-o"></i>彻底删除</a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <?php if(is_check_access('RecycleBin@gbookattr_recovery') == '1'): ?>
                <div class="fbutton">
                    <a onclick="batch_recovery(this, 'ids');" data-url="<?php echo url('RecycleBin/gbookattr_recovery'); ?>">
                ...
                <?php endif; if(is_check_access('RecycleBin@gbookattr_del') == '1'): ?>
                <div class="fbutton">
                    <a onclick="batch_del(this, 'ids');" data-url="<?php echo url('RecycleBin/gbookattr_del'); ?>">
...
<script type="text/javascript">
    ...
    function recovery(obj){
        layer.confirm('<font color="red">表单与关联栏目将一起还原</font>，确认还原？', {
    ...
    function batch_recovery(obj, name) {
        ...
        // 还原按钮
        layer.confirm('<font color="red">选定表单与关联栏目一起还原</font>，确认批量还原？', {
            title: false,
            btn: ['确定', '取消'] //按钮
        }, function () {
            layer_loading('正在处理');
