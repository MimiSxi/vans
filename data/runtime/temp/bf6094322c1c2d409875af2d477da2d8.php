    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Field/channel_edit'); ?>" method="post">
        ...
        <div class="ncap-form-default tab_div_1">
                ...
                <dd class="opt">
                    <?php if(is_array($fieldtype_list) || $fieldtype_list instanceof \think\Collection || $fieldtype_list instanceof \think\Paginator): $i = 0; $__LIST__ = $fieldtype_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <div style="width: 150px; float: left;">
                            <label><input type="radio" name="dtype" value="<?php echo $vo['name']; ?>" data-ifoption="<?php echo (isset($vo['ifoption']) && ($vo['ifoption'] !== '')?$vo['ifoption']:0); ?>" <?php if($info['dtype'] == $vo['name']): ?> checked="checked" <?php endif; ?> data-text="<?php echo $vo['title']; ?>"><?php echo $vo['title']; ?></label>&nbsp;
                        </div>
                        <?php if($i % 4 == 0): ?><br/><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                    <input type="hidden" name="old_dtype" value="<?php echo $info['dtype']; ?>">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <dl class="row" id="dl_dfvalue">
                ...
                <dd class="opt">
                    <textarea rows="5" cols="60" id="dfvalue" name="dfvalue" placeholder="如果定义字段类型为下拉框、单选项、多选项时，此处填写被选择的项目(用“,”分开，如“男,女”)。" style="height:60px;"><?php echo (isset($info['dfvalue']) && ($info['dfvalue'] !== '')?$info['dfvalue']:''); ?></textarea>
                    <span class="err"></span>
            ...
            <dl class="row" id='IsScreening' style="display: none;">
                ...
                <dd class="opt">
                    ...
                    <a id="call_tags_help" href="JavaScript:void(0);" onclick="click_to_eyou_1575506523('https://www.eyoucms.com/plus/view.php?aid=7881','筛选标签调用')" class="<?php if(!isset($info['is_screening']) || empty($info['is_screening'])): ?>none<?php endif; ?>">查看标签调用</a>
                </dd>
            </dl>
