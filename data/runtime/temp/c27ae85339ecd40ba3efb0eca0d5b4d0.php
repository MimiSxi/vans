<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"./application/admin/template/users_release\conf.htm";i:1610099631;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:77:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\member\bar.htm";i:1610099620;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="ncap-form-default">
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        &nbsp; &nbsp; &nbsp; &nbsp;
                        <span style="padding-left: 10px; color: #C0C0C0;">开启后资料上传将直接展示到前台文档列表</span>
                    </dd>
                </dl>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        <span style="padding-left: 10px; color: #C0C0C0;">开启后可设置用户每日的投搞数量</span>
                    </dd>
                </dl>
