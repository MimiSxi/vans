        ...
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show div_litpic_local">
                        <span class="show">
                            <a id="img_a" target="_blank" class="nyroModal" rel="gal" href="javascript:void(0);">
                                <i id="img_i" class="fa fa-picture-o" onmouseover=""
                                   onmouseout="layer.close(layer_tips);"></i>
                            </a>
                        </span>
                    ...
                    <input type="text" id="litpic_remote" name="litpic_remote" value="" placeholder="http://"
                           class="input-txt" onKeyup="keyupRemote(this, 'litpic');" style="display: none;">
                    &nbsp;
                    <label><input type="checkbox" name="is_remote" id="is_remote" value="1"
                                  onClick="clickRemote(this, 'litpic');">远程图片</label>
                    <span class="err"></span>
                    <p class="notic">当没有手动上传图片时候，会自动提取正文的第一张图片作为缩略图</p>
                    &nbsp;<a href="javascript:void(0);" onclick="system_thumb();"
                             class="ncap-btn ncap-btn-green">缩略图配置</a>
                </dd>
            </dl>
            ...
            <dl class="row" id="fahuoxingshi">
                ...
                <dd class="opt">
                    <label>
                        <input type="radio" name="prom_type_vir" value="1" checked="checked"
                               onclick="change_prom_type(2)"/>手动发货
                    </label>
                    &nbsp;
                    <label>
            ...
            <div id="wangpanxiazai" class="none">
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input type="text" name="netdisk_url" value="" id="netdisk_url" class="input-txt"
                               placeholder="http://">
                        <span class="err"></span>
            ...
            <dl class="row none" id="wenbenneirong">
                ...
                <dd class="opt">
                    <textarea rows="5" cols="80" id="text_content" name="text_content"
                              style="width: 375px;height:160px;"></textarea>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <?php endif; endif; if(1 == $shopConfig['shop_open'] && !empty($ifcontrolRow['users_price'])): if(!isset($shopConfig['shop_open_spec']) || 0 == $shopConfig['shop_open_spec']): else: ?>
            <dl class="row">
                <dt class="tit">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="users_price" id="users_price" maxlength="100" placeholder="原价"
                           style="width: 10%;">
    ...
    function showEditor_1597892187(elemtid){
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            请先在【常规选项】里选择产品主栏目，再点击【<a
                                                href="<?php echo url('Product/attribute_index', array('typeid'=>$typeid)); ?>">参数选项</a>】进行更多操作。
                                            <?php else: ?>
        ...
        <div class="ncap-form-default tab_div_3" style="display:none;">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea rows="5" cols="60" id="seo_description" name="seo_description"
        ...
        <div class="ncap-form-default tab_div_4" style="display:none;">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?php echo (\think\Session::get('admin_info.pen_name') ?: '小编'); ?>" name="author"
                           id="author" class="input-txt">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?php echo mt_rand(100, 300); ?>" name="click" id="click"
                           class="input-txt">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" class="input-txt" id="add_time" name="add_time"
                           value="<?php echo date('Y-m-d H:i:s') ?>" autocomplete="off">
            ...
            <dd class="opt">
                <input type="text" value="" name="htmlfilename" id="htmlfilename" style="width: 120px;"
