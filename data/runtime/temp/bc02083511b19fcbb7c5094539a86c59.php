<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin/template/index\index.htm";i:1610006963;s:81:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\menubox.htm";i:1571728724;s:78:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\left.htm";i:1591186160;}*/ ?>
<!doctype html>
<html>
<head>
...
<title><?php echo (isset($global['web_name']) && ($global['web_name'] !== '')?$global['web_name']:''); ?>-<?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?>企业网站管理系统<?php endif; ?><?php echo $version; ?></title>
        ...
        <div class="admincp-header-r">
          <div class="manager">
            ...
            <div class="btn-group pull-left ey-tool">
              ...
              <?php if(is_check_access('Index@switch_map') == '1'): if($function_switch == 'true'): ?>
                <a class="btn btn-default dropdown-toggle" href="javascript:void(0);" onclick="switch_map();">
                  <i class="fa fa-toggle-on"></i>
                  <span class="hidden-xs">功能地图</span>
                </a>
                <?php endif; endif; if($admin_info['user_name'] == 'admin'): if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?>
              <!-- 商业授权 -->   
