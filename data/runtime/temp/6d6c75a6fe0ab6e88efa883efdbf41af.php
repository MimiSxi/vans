<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:46:"./application/admin/template/special\index.htm";i:1600132627;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:78:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\special\bar.htm";i:1600131529;s:84:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\archives\tags_btn.htm";i:1600337629;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="box-shadow:none;">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            <div class="ftitle">
                <h3><?php echo (isset($arctype_info['typename']) && ($arctype_info['typename'] !== '')?$arctype_info['typename']:'全部专题'); ?></h3>
                <h5>(共<?php echo $pager->totalRows; ?>条数据)</h5>
            </div>
            <div title="刷新数据" class="pReload"><i class="fa fa-refresh"></i></div>
            <form class="navbar-form form-inline" id="searchForm" action="<?php echo url('Special/index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
        ...
        function quick_release()
        {
            ...
            layer.open({
                ...
                success: function(layero, index){
                    ...
                    <!-- <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo url('Special/index', array("typeid"=>\think\Request::instance()->param('typeid'))); ?>';">
                    </div> -->
                </div>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="" style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    ...
                                    <a href="<?php echo url('Special/edit',array('id'=>$vo['aid'])); ?>" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold;<?php endif; ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                            ...
                            <td class="">
                                <div class="w100 tc"><a href="<?php echo url('Special/index', array('typeid'=>$vo['typeid'], 'tab'=>3)); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="tc w50">
                                    <?php if($vo['arcrank'] == -1): ?>
                            ...
                            <td class="">
                                <div class="w180 tc">
                                    <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>
                                    <a href="<?php echo url('Special/edit',array('id'=>$vo['aid'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Special/del'); ?>" data-id="<?php echo $vo['aid']; ?>" data-deltype="pseudo" onClick="delfun(this);"><i class="fa fa-trash-o"></i>删除</a>
                                    <?php endif; ?>
        ...
        <div class="footer-oper">
            ...
            <div class="nav-dropup">
                ...
                <div class="dropdown-menus" style="display:none;">
                    ...
                    <a href="javascript:void(0);" onclick="func_batch_copy(this, 'ids');" data-url="<?php echo url('Archives/batch_copy', array('typeid'=>\think\Request::instance()->param('typeid'))); ?>"><i class="fa fa-copy"></i>复制专题</a>
                    <?php endif; if(is_check_access('Archives@move') == '1'): ?>
                    <a href="javascript:void(0);" onclick="func_move(this, 'ids');" data-url="<?php echo url('Archives/move', array('typeid'=>\think\Request::instance()->param('typeid'))); ?>"><i class="fa fa-hdd-o"></i>移动专题</a>
                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                    <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Special/del'); ?>" data-deltype="pseudo"><i class="fa fa-close"></i>删除专题</a>
                    <?php endif; if(is_check_access('Archives@check') == '1'): ?>
                    <a href="javascript:void(0);" onclick="batch_check(this, 'ids');" data-url="<?php echo url('Archives/check'); ?>"><i class="fa fa-check-square-o"></i>审核专题</a>
                    <?php endif; ?>
                </div>
            </div>
