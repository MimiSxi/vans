<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:35:"./template/pc/users\article_add.htm";i:1609135619;s:74:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\users\skin\css\diy_css.htm";i:1608270448;s:70:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\users\users_header.htm";i:1610099618;s:49:"./public/static/template/users/users_leftmenu.htm";i:1571728724;s:68:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\users\users_left.htm";i:1571728724;s:69:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\users\release_bar.htm";i:1571728724;s:70:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\users\users_footer.htm";i:1610071753;}*/ ?>
<!DOCTYPE HTML>
            ...
            投稿列表
                                ...
                                <div class="panel-body" style="padding-top:0">
                                    <form class="form-horizontal" id="post_form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9">
                                                <div class="input-file-show div_litpic_local" <?php if($is_mobile == '1'): ?> onClick="GetUploadify_mobile(1,'','缩略图')" <?php else: ?> onClick="GetUploadify(1,'','allimg','litpic_call_back','','缩略图')"
                                                <?php endif; ?>> <img id='litpic_img'
                                                                 src="/public/static/common/images/not_adv.jpg"/><span>上传缩略图</span>
                                            ...
                                            <div class="images_upload">
                                                <div style="position: relative; height: 130px;">
                                                    ...
                                                    <a href="javascript:void(0);" onClick="" class="upimg"
                                                       title="拖动修改排序">
                                                        <img src="/public/static/admin/images/add-button.jpg" width="120"
                                                             height="120"/>
                                                    </a>
                                ...
                                <script type="text/javascript">
                                    $(function () {
                                        ...
                                        GetAddonextitem(0, typeidNew, false);

                                        $('#typeid').change(function () {
                                            GetAddonextitem(1, $(this).val(), true);
                                        });
                                    });

                                    function GetAddonextitem(init, typeidNew, is_destroy) {
                                ...
                                <div class="row" style="border-bottom:none;">
                                    ...
                                    <div class="col-xs-9">
                                        <input type="button" data-url="<?php echo url('UsersRelease/article_add'); ?>"
                                               onclick="AddArticle(this);" class="btn btn-primary" value="确认提交"/>
                                    </div>
                                </div>
                                <!-- 表单验证 -->
                                <?php echo $TokenValue; ?>
