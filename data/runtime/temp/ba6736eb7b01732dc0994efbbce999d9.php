<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"./application/admin/template/download\index.htm";i:1596507476;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:78:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\article\bar.htm";i:1573115083;s:84:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\archives\tags_btn.htm";i:1600337629;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="box-shadow:none;">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="searchForm" action="<?php echo url('Download/index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                        ...
                        <tr>
                            ...
                            <td style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    ...
                                    <a href="<?php echo url('Download/edit',array('id'=>$vo['aid'])); ?>" title="<?php echo $vo['title']; ?>" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold;<?php endif; ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                            ...
                            <td>
                                <div class="w100 tc"><a href="<?php echo url('Download/index', array('typeid'=>$vo['typeid'], 'tab'=>3)); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="tc w50">
                            ...
                            <td>
                                <div class="w180 tc">
                                    <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>
                                    <a href="<?php echo url('Download/edit',array('id'=>$vo['aid'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Download/del'); ?>" data-id="<?php echo $vo['aid']; ?>" data-deltype="pseudo" onClick="delfun(this);"><i class="fa fa-trash-o"></i>删除</a>
        ...
        <div class="footer-oper">
            ...
            <div class="nav-dropup">
                ...
                <div class="dropdown-menus" style="display:none;">
                    ...
                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                    <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Download/del'); ?>" data-deltype="pseudo"><i class="fa fa-close"></i>删除文档</a>
