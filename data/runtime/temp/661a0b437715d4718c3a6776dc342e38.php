...
<div class="page" style="min-width:auto;box-shadow:none;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Special/add'); ?>" method="post">
        <!-- 常规信息 -->
