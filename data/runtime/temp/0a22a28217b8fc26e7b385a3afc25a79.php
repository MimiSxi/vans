<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"./application/admin/template/archives\ajax_newtpl.htm";i:1600326195;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;box-shadow:none;">
    <form class="form-horizontal" id="post_form" action="<?php echo url('Archives/ajax_newtpl'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea name='content' id="content" style='width:99%;height:500px;background:#ffffff;' tabindex="3"><?php echo (isset($content) && ($content !== '')?$content:''); ?></textarea>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#filename').keyup(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo url('Archives/ajax_newtpl', ['nosubmit'=>1,'_ajax'=>1]); ?>",
    ...
    function checkForm(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo url('Archives/ajax_newtpl', ['_ajax'=>1]); ?>",
