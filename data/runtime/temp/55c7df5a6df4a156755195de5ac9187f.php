...
<div class="page" style="min-width:auto;box-shadow:none;">
    <div class="flexigrid" style="margin-top: 0px;">
        <div class="mDiv" style="padding: 5px 0px;">
            ...
            <form id="searchForm" class="navbar-form form-inline" action="<?php echo url('Archives/index_archives'); ?>"
                  method="get" onsubmit="layer_loading('正在处理');">
            ...
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td class="">
                            <div class="w100 tc"><a
                                    href="<?php echo url('Archives/index_archives', array('typeid'=>$vo['typeid'])); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i
                                    class="red">数据出错！</i>'); ?></a></div>
                        </td>
                        <td>
                            <div class="tc w50">
                                <?php if($vo['arcrank'] == -1): ?>
                        ...
                        <td class="">
                            <div class="w180 tc">
                                ...
                                <a href="<?php echo $vo['arcurl']; ?>" target="_blank" class="btn blue"><i
                                        class="fa fa-pencil-square-o"></i>浏览</a>
                                <?php endif; if($vo['channel'] == 101): ?>
                                <a href="<?php echo url('Archives/add',array('id'=>$vo['aid'],'typeid'=>80, 'channel'=>102)); ?>"
                                            class="btn blue"><i class="fa fa-pencil-square-o"></i>添加产品</a>
                                <?php endif; if($vo['channel'] == 102): ?>
                                <a href="<?php echo url('InAndOut/add',array('id'=>$vo['aid'])); ?>"
                                   class="btn blue"><i class="fa fa-pencil-square-o"></i>出入库</a>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="sort">
                            <div class="w60 tc">
                                ...
                                <input type="text"
                                       onchange="changeTableVal('archives','aid','<?php echo $vo['aid']; ?>','sort_order',this);"
                                       size="4" value="<?php echo $vo['sort_order']; ?>"/>
                                <?php else: ?>
