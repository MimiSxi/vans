<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"./template/pc/view_article.htm";i:1608081304;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\header.htm";i:1608277259;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\banner.htm";i:1608081236;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<ol class="am-breadcrumb">
  ...
  <div class="news_show">
    ...
    <div class="info">
        作者：<?php echo $eyou['field']['author']; ?>　日期：<?php echo MyDate('Y-m-d H:i:s',$eyou['field']['add_time']); ?>　点击数：<?php  if(!isset($aid) || empty($aid)) : $aid = "0"; endif; $tagArcclick = new \think\template\taglib\eyou\TagArcclick; $__VALUE__ = $tagArcclick->getArcclick($aid, "", ""); echo $__VALUE__; ?>　
    </div>
    <div class="intro">
  ...
  <div class="subject m20"> <b>随便看看</b> </div>
   ...
   <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = ""; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 4; endif; $channelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $channelid,      "joinaid"=> "",      "keyword"=> "", ); $tag = array (
  'orderby' => 'rand',
  'titlelen' => '30',
  'row' => '4',
