<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"./application/admin/template/channeltype\index.htm";i:1590400319;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                            ...
                            <td class="">
                                <div class="tl <?php if(empty($vo['ifsystem']) || (($vo['ifsystem'] instanceof \think\Collection || $vo['ifsystem'] instanceof \think\Paginator ) && $vo['ifsystem']->isEmpty())): ?>w230<?php else: ?>w160<?php endif; ?>">
                                    ...
                                    <?php endif; if(is_check_access('Channeltype@edit') == '1'): if($vo['nid'] == 'guestbook'): ?>
                                        <a href="<?php echo url('Field/attribute_index'); ?>" class="btn blue"><i class="fa fa-code blocki"></i>内容字段</a>
                                        <?php else: ?>
