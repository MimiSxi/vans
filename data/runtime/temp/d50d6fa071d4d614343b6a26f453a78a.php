<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"./application/admin/template/product\attribute_index.htm";i:1573115083;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?php echo url('Product/attribute_index', array('typeid'=>\think\Request::instance()->param('typeid'), 'tab'=>$tab)); ?>" data-index='3' class="tab <?php if($tab == '3'): ?>current<?php endif; ?>"><span>参数列表</span></a></li>
            </ul>
        </div>
    </div>
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form id="searchForm" class="navbar-form form-inline" action="<?php echo U('Product/attribute_index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
