<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:29:"./template/pc/view_images.htm";i:1608082253;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\header.htm";i:1608277259;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\banner.htm";i:1608081236;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="firsttop_right">
      ...
      <div class="pictwo">
        <ul>
         ...
         <?php else: ?>
           <li><a href="javascript:void(0);"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/nimg.png" /></a>
    ...
    <div class="picshow">
      ...
      <div class="picshowlist"> 
        ...
        <?php  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("pre");if(!empty($_result) || (($_result instanceof \think\Collection || $_result instanceof \think\Paginator ) && $_result->isEmpty())): $field = $_result; $field["title"] = text_msubstr($field["title"], 0, 100, false); ?>
         ...
         <?php else: ?>
        <div class="picshowlist_left">
          <div class="picleftimg"> <a href="javascript:void(0);"><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/nimg.png" /></a> </div>
