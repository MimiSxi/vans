...
class UsersRelease extends Base
{
    public function _initialize() {
        parent::_initialize();
        $this->users_menu_db   = Db::name('users_menu');  // 用户中心栏目表
...
//        $where['current_channel'] = $channel_id;
        $where['current_channel'] = ['in',[1,2,3,4,5,6,7,8,101,102,103]];
