        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">          
                    ...
                    <br/>适合谷歌和百度，地图网址 <a href="http://vans.cc:8088/sitemap.xml" target="_blank">http://vans.cc:8088/sitemap.xml</a>
                    &nbsp;&nbsp;<a href="javascript:void(0);" onclick="update_sitemap();" class="ncap-btn ncap-btn-green">更新地图</a>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic">发布/编辑文档时，会同步更新sitemap.xml，包含首页、栏目页、指定数量的最新发布文档。</p>
                    <p class="<?php if($config['sitemap_tags_num'] <= '100'): ?>none<?php endif; ?> red" id="p_sitemap_tags_num">推荐设置100篇，数量设置越多，会对文档发布/编辑的速度造成一定影响。</p>
                </dd>
            </dl>
