<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./template/pc/view_workmanagement.htm";i:1609825521;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wrapper">
    ...
    <main>
        <article class="content">
            ...
            <h1><?php echo $eyou['field']['aid']; ?></h1>
            <h1><?php echo $eyou['field']['id']; ?></h1>
            <h1>设计师名称：<?php echo $eyou['field']['designername']; ?></h1>
            <div class="meta">
