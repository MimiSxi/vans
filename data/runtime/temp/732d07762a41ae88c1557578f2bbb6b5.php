...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" action="<?php echo url('RecycleBin/customvar_index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
...
<div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
    <input type="button" class="btn <?php if(\think\Request::instance()->action() != 'gbookattr_index'): ?>current<?php else: ?>selected<?php endif; ?>" value="留言属性" onClick="window.location.href='<?php echo url('RecycleBin/gbookattr_index'); ?>';">
                    ...
                    <!-- <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo url('RecycleBin/customvar_index'); ?>';">
                    </div> -->
                </div>
            </form>
        </div>
                ...
                <table style="width: 100%">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td>
                                <div class="w150 tc">
                                    <?php if(is_check_access('RecycleBin@customvar_recovery') == '1'): ?>
                                    <a class="btn blue" href="javascript:void(0);" data-url="<?php echo url('RecycleBin/customvar_recovery'); ?>" data-id="<?php echo $vo['id']; ?>" data-attr_var_name="<?php echo $vo['attr_var_name']; ?>" onClick="recovery(this);"><i class="fa fa-trash-o"></i>还原</a>
                                    <?php endif; if(is_check_access('RecycleBin@customvar_del') == '1'): ?>
                                    <a class="btn red" href="javascript:void(0);" data-url="<?php echo url('RecycleBin/customvar_del'); ?>" data-id="<?php echo $vo['id']; ?>" data-attr_var_name="<?php echo $vo['attr_var_name']; ?>" onClick="delfun(this);"><i class="fa fa-trash-o"></i>彻底删除</a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <?php if(is_check_access('RecycleBin@customvar_recovery') == '1'): ?>
                <div class="fbutton">
                    <a onclick="batch_recovery(this, 'ids');" data-url="<?php echo url('RecycleBin/customvar_recovery'); ?>">
                ...
                <?php endif; if(is_check_access('RecycleBin@customvar_del') == '1'): ?>
                <div class="fbutton">
                    <a onclick="batch_del(this, 'ids');" data-url="<?php echo url('RecycleBin/customvar_del'); ?>">
