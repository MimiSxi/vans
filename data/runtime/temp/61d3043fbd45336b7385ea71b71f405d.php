...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="<?php echo $backurl; ?>" title="返回列表"><i class="fa fa-chevron-left"></i></a>
            <div class="subject">
                <h3>用户中心 - 编辑用户</h3>
                <h5></h5>
            </div>
    ...
    <form class="form-horizontal" id="postForm" action="<?php echo url('Member/users_edit'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="last_login">最后登录日期</label>
                </dt>
                <dd class="opt">
