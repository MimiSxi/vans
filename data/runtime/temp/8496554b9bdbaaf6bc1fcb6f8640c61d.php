                ...
                <table style="width: 100%">
                    ...
                    <?php else: if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): if( count($info)==0 ) : echo "" ;else: foreach($info as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="sort">
                                <div class="w40 tc"><?php echo $vo['para_id']; ?></div>
                            </td>
                            <td style="width: 100%">
                                <div style="">
                            ...
                            <td>
                                <div class="w80 tc">
                                    <?php if($vo['is_reg'] == 1): ?>
                                        <span class="yes" <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>onClick="changeTableVal('users_parameter','para_id','<?php echo $vo['para_id']; ?>','is_reg',this);"<?php endif; ?>><i class="fa fa-check-circle"></i>是</span>
                                    <?php else: ?>
                                        <span class="no" <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>onClick="changeTableVal('users_parameter','para_id','<?php echo $vo['para_id']; ?>','is_reg',this);"<?php endif; ?>><i class="fa fa-ban"></i>否</span>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td class="">
                                <div class="w120 tc">
                                    ...
                                    <?php endif; if($vo['is_system'] == '0'): if(is_check_access('Member@attr_del') == '1'): ?>
