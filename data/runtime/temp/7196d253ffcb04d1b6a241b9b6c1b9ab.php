...
<div class="page" style="min-width:auto;box-shadow:none;">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/edit'); ?>" method="post">
        ...
        <dl class="row <!-- #weapp_diy911873092_product_none# -->">
            ...
            <dd class="opt">
                <div class="tab-pane pics" id="tab_proimg">
                    <a href="javascript:void(0);" onClick="GetUploadify(30,'','allimg','proimg_call_back');"
                       class="imgupload">
                            ...
                            <td class="sort-list">
                                ...
                                <div class="images_upload" style="display:inline-block;">
                                    <div style="position: relative; height: 130px;">
                                        ...
                                        <a href="<?php echo $vo['image_url']; ?>" onclick="" class="upimg" target="_blank"
                                           title="拖动修改排序">
                                            <img src="<?php echo $vo['image_url']; ?>" width="120" height="120">
                                        </a>
                                        <a href="javascript:void(0)" onclick="ClearPicArr2(this,'<?php echo $vo['image_url']; ?>')"
                                           class="delect">删除</a>
                                    </div>
                                    <textarea rows="5" cols="60" name="imgintro[]" style="height:28px; width: 136px;"
                                              placeholder="图片注释"><?php echo $vo['intro']; ?></textarea>
                                </div>
        ...
        <dl class="row" id="fahuoxingshi" {empty name="$field.prom_type" } style="display: none;" {
        /empty}>
        <dt class="tit">
        ...
        <div id="wangpanxiazai" {neq name="$field.prom_type" value="2" } style="display: none;" {
        /neq}>
        <dl class="row">
            <dt class="tit">
            ...
            <dd class="opt">
                <input type="text" name="netdisk_url" id="netdisk_url" value="<?php echo (isset($netdisk['netdisk_url']) && ($netdisk['netdisk_url'] !== '')?$netdisk['netdisk_url']:''); ?>"
                       class="input-txt" placeholder="http://">
                <span class="err"></span>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" name="netdisk_pwd" value="<?php echo (isset($netdisk['netdisk_pwd']) && ($netdisk['netdisk_pwd'] !== '')?$netdisk['netdisk_pwd']:''); ?>" id="netdisk_pwd"
                       class="input-txt">
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input type="text" name="unzip_pwd" value="<?php echo (isset($netdisk['unzip_pwd']) && ($netdisk['unzip_pwd'] !== '')?$netdisk['unzip_pwd']:''); ?>" id="unzip_pwd"
                       class="input-txt">
                <span class="err"></span>
                <p class="notic"></p>
            </dd>
...
<dl class="row" id="wenbenneirong" {neq name="$field.prom_type" value="3" } style="display: none;" {
/neq}>
<dt class="tit">
...
<dl class="row">
    ...
    <dd class="opt">
        <input type="text" name="users_price" id="users_price" maxlength="100" placeholder="原价" style="width: 10%;"
               value="<?php echo $field['users_price']; ?>">
        <span class="err"></span>
        <p class="notic"></p>
    </dd>
</dl>
...
<dl class="row">
    ...
    <dd class="opt">
        <input type="text" name="stock_count" style="width: 10%;"
               value="<?php if(empty($field['stock_count']) || (($field['stock_count'] instanceof \think\Collection || $field['stock_count'] instanceof \think\Paginator ) && $field['stock_count']->isEmpty())): ?>99999<?php else: ?><?php echo $field['stock_count']; endif; ?>">
        <label>
...
<dl class="row">
    ...
    <dd class="opt">
        <input type="text" name="stock_count" <?php if(!(empty($spec_mark_id_arr) || (($spec_mark_id_arr instanceof \think\Collection || $spec_mark_id_arr instanceof \think\Paginator ) && $spec_mark_id_arr->isEmpty()))): ?>readonly="readonly" <?php endif; ?>
        id="stock_count" style="width: 10%;" maxlength="100" value="<?php echo $field['stock_count']; ?>">
        <label>
            <input type="checkbox" name="stock_show" value='1' <?php if($field['stock_show'] == '1'): ?>checked<?php endif; ?>>页面显示商品库存
        </label>
        <span class="err"></span>
    ...
    function SpecSelectName(obj) {
        ...
        $.ajax({
            ...
            data: {
                ...
                preset_mark_id_arr: spec_mark_id_arr,
                _ajax: 1
            },
            dataType: 'json',
            success: function (res) {
...
<div class="ncap-form-default tab_div_2" style="display:none;">
                        ...
                        <div id="explanation" class="explanation"
                            ...
                            <ul>
                                <li>
                                    ...
                                    请先在【常规选项】里选择产品主栏目，再点击【<a
                                        href="<?php echo url('Product/attribute_index', array('typeid'=>$field['typeid'])); ?>">参数选项</a>】进行更多操作。
                                    <?php else: ?>
                                    如果想对产品参数进行新增、修改、删除等操作，请点击【<a
                                        href="<?php echo url('Product/attribute_index', array('typeid'=>$field['typeid'])); ?>">参数选项</a>】进行更多操作。
                                    <?php endif; ?>
                                </li>
                            </ul>
    ...
    <dl class="row" style="margin-top: 10px;" id="product_attr_table">
        ...
        <div style="color: red;font-size: 12px;text-align: center;">提示：该主栏目还没有参数值，若有需要请点击【<a
                href="<?php echo url('Product/attribute_index', array('typeid'=>$field['typeid'])); ?>">参数选项</a>】进行更多操作。
        </div>
        <?php else: ?>
