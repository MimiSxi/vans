<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:31:"./template/pc/view_download.htm";i:1608081324;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\header.htm";i:1608277259;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\banner.htm";i:1608081236;s:58:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\template\pc\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="dow_show">
   <div class="infobox">
      ...
      <div class="txt">
      	...
      	<span><?php echo html_msubstr($eyou['field']['seo_description'],0,90,true); ?></span>
      	<div class="property">
     	  <span>作者：<?php echo $eyou['field']['author']; ?></span>
      	  <span>上传时间：<?php echo MyDate('Y-m-d',$eyou['field']['add_time']); ?></span>
      	  <span>浏览量：<?php echo $eyou['field']['click']; ?></span>
      	</div>
      </div>
     <div class="xia">文件下载列表 : 
		...
		<span class="xiazai"><a href="<?php echo $field['downurl']; ?>" title="<?php echo $field['file_name']; ?>"><?php echo $field['file_name']; ?>(<?php echo $field['file_size']; ?>)</a></span>
   ...
   <div class="subject m20"><b>详细介绍</b> </div>
    <div class="intro">
