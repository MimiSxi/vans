<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./application/user/template/uploadify/upload.htm";i:1604970603;}*/ ?>
<html lang="zh-cn">
<head>
...
<script type="text/javascript" src="/public/static/common/js/jquery.min.js?v=<?php echo (isset($version) && ($version !== '')?$version:'1.2.9'); ?>"></script>
