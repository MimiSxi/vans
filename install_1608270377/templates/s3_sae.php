      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbprefix" id="dbprefix" disabled="disabled" value="ey_" class="input" disabled></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个EyouCMS时需修改</span></div></td>
          </tr>
        </table>
		<table width="100%">
          <tr>
          ...
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value=""></td>
