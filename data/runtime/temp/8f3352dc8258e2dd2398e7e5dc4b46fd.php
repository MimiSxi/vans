    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" action="<?php echo url('Field/arctype_index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                ...
                <div class="sDiv">
                    ...
                    <!-- <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo url('Field/arctype_index'); ?>';">
                    </div> -->
                </div>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td style="width: 100%">
                                ...
                                <?php if(empty($vo['ifsystem'])): if(is_check_access(CONTROLLER_NAME.'@arctype_edit') == '1'): ?>
                                    <a href="<?php echo url('Field/arctype_edit',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                            ...
                            <td class="">
                                <div class="w180 tc">
                                <?php if(empty($vo['ifsystem'])): if(is_check_access(CONTROLLER_NAME.'@arctype_edit') == '1'): ?>
                                    <a href="<?php echo url('Field/arctype_edit',array('id'=>$vo['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@arctype_del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Field/arctype_del'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this);"><i class="fa fa-trash-o"></i>删除</a>
                                    <?php endif; else: ?>
                                    ——————
                                <?php endif; ?>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a href="<?php echo url('Field/arctype_add'); ?>">
