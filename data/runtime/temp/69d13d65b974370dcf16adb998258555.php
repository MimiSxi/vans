<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"./application/admin/template/member\users_batch_add.htm";i:1573115083;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:85:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\member\users_field.htm";i:1609209064;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title"><a class="back" href="<?php echo url('Member/users_index'); ?>" title="返回列表"><i class="fa fa-chevron-left"></i></a>
            <div class="subject">
                <h3>用户中心 - 批量新增用户</h3>
                <h5></h5>
            </div>
    ...
    <form class="form-horizontal" id="postForm" action="<?php echo url('Member/users_batch_add'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <?php if(1 == $userConfig['level_member_upgrade']): ?>
                <dl class="row" style="display: none;" id='users_days'>
                    <dt class="tit">
                        <label for="users_days"><em>*</em>用户天数</label>
                    </dt>
                    <dd class="opt">
                        ...
                        <span class="err"></span>
                        <p class="notic">请填写用户有效期天数，不填写则会默认为注册用户！</p>
                    </dd>
                </dl>
            <?php endif; ?>
            ...
            <!-- 用户属性 开始 -->
            <?php if(is_array($users_para) || $users_para instanceof \think\Collection || $users_para instanceof \think\Paginator): $i = 0; $__LIST__ = $users_para;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;switch($vo['dtype']): case "hidden": ?>
                <!-- 隐藏域 start -->
                ...
                <!-- 隐藏域 start -->
            <?php break; case "text":case "email":case "mobile": ?>
                <!-- 单行文本框 start -->
                <dl class="row">
                    <dt class="tit">
                        <label><?php if(1 == $vo['is_required']): ?><!-- <em>*</em> --><?php endif; ?><?php echo $vo['title']; ?></label>
                    </dt>
                    <dd class="opt">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <button type="button" class="layui-btn" id="upload_<?php echo $vo['fieldArr']; ?>_<?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:''); ?>" style="height: 30px;line-height: 30px;padding: 0 5px;background-color: #4fc0e8;">上传文件</button>
                </dd>
            </dl>
            <script type="text/javascript">
