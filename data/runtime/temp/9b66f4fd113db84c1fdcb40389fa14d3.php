<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"./application/admin/template/seo\seo.htm";i:1591750654;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:74:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\seo\bar.htm";i:1585574499;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo url('Seo/handle'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            ...
            <dl class="row <?php if(empty($config['seo_pseudo']) || 1 != $config['seo_pseudo'] || (1 == $config['seo_pseudo'] && 1 == $config['seo_dynamic_format'])): ?>none<?php endif; ?>" id="dl_seo_dynamic_format">
                ...
                <dd class="opt">
                    <label><input type="radio" name="seo_dynamic_format" value="1" <?php if(!isset($config['seo_dynamic_format']) OR $config['seo_dynamic_format'] == 1): ?>checked="checked"<?php endif; ?>>完全兼容（<a href="javascript:void(0);" onclick="view_exp('view_1_1');">查看例子</a><span id="view_1_1" class="none">：http://vans.cc:8088/index.php?m=home&amp;c=Lists&amp;a=index&amp;tid=1</span>）</label>&nbsp;
                    <?php if(isset($config['seo_dynamic_format']) AND $config['seo_dynamic_format'] == 2): ?>
                    <br/>
                    <label><input type="radio" name="seo_dynamic_format" value="2" checked="checked">部分兼容&nbsp;<font color="red">[部分空间不支持]</font>（<a href="javascript:void(0);" onclick="view_exp('view_1_2');">查看例子</a><span id="view_1_2" class="none">：http://vans.cc:8088/home/Lists/index.html?tid=1</span>）</label>&nbsp;
                    <?php endif; ?>
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            ...
            <dl class="row <?php if(isset($config['seo_pseudo']) && $config['seo_pseudo'] != 3): ?>none<?php endif; ?>" id="dl_seo_rewrite_format">
                ...
                <dd class="opt">
                    <label><input type="radio" name="seo_rewrite_format" value="1" <?php if(!isset($config['seo_rewrite_format']) OR $config['seo_rewrite_format'] == 1): ?>checked="checked"<?php endif; ?>>目录名称（<a href="javascript:void(0);" onclick="view_exp('view_3_1');">查看例子</a><span id="view_3_1" class="none">：http://vans.cc:8088/about/</span>）</label>&nbsp;
                    <br/>
                    <label><input type="radio" name="seo_rewrite_format" value="2" <?php if(isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 2): ?>checked="checked"<?php endif; ?>>模型标识（<a href="javascript:void(0);" onclick="view_exp('view_3_2');">查看例子</a><span id="view_3_2" class="none">：http://vans.cc:8088/single/about.html</span>）</label>&nbsp;
                    <br/>
                    <label><input type="radio" name="seo_rewrite_format" value="3" <?php if(isset($config['seo_rewrite_format']) AND $config['seo_rewrite_format'] == 3): ?>checked="checked"<?php endif; ?>>子目录名称（<a href="javascript:void(0);" onclick="view_exp('view_3_3');">查看例子</a><span id="view_3_3" class="none">：http://vans.cc:8088/news/</span>）</label>&nbsp;
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
