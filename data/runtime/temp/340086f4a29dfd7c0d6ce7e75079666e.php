<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./application/admin/template/system\web.htm";i:1599730875;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\layout.htm";i:1596507477;s:77:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\system\bar.htm";i:1610074000;s:80:"C:\software\EyouCMS-V1.4.9-UTF8-SP2\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <dl class="row">
                ...
                <dd class="opt ui-keyword">
                    <?php if($config['web_recordnum_mode'] == '1'): ?>
                        <textarea rows="5" cols="60" id="web_recordnum" name="web_recordnum" style="height:40px;"><?php echo (isset($config['web_recordnum']) && ($config['web_recordnum'] !== '')?$config['web_recordnum']:''); ?></textarea>
                    <?php else: ?>
                        <textarea rows="5" cols="60" id="web_recordnum" name="web_recordnum" style="height:20px;"><?php echo strip_tags(htmlspecialchars_decode($config['web_recordnum'])); ?></textarea>
                    <?php endif; ?>
...
<script type="text/javascript">
    ...
    function show_recordnum(obj)
    {
        ...
        if (value.indexOf('&lt;/a&gt;') == -1) {
            valuehtml = '<a href="http://beian.miit.gov.cn/" rel="nofollow" target="_blank">'+value+'</a>';
        }
