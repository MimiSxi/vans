                    ...
                    <div class="post">
                        <div class="md_block">
                            <div style=" color: #ff0000">
                                制作留言表单<br>1，后台>开启留言模型，建立栏目并选择留言模型。<br>2，打开根目录>template>{$tpl_theme}pc>lists_guestbook.htm模板文件，按照表单标签制作<br>
                            </div>
                        </div>           
                    </div>
                </article>
...
<div class="md_block">
                            <p>
                                ...
                                {eyou:memberinfos mid='\$eyou.field.users_id' id="users"}
                                    用户头像：<img src="{\$users.head_pic|get_head_pic=###}" width='50' height='50' /><br/>
                                    用户昵称：{\$users.nickname}<br/>
                                {/eyou:memberinfos}
