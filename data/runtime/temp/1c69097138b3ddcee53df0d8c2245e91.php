...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form id="search_form" class="navbar-form form-inline" action="<?php echo url('RecycleBin/proattr_index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
...
<div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
    <input type="button" class="btn <?php if(\think\Request::instance()->action() != 'gbookattr_index'): ?>current<?php else: ?>selected<?php endif; ?>" value="留言属性" onClick="window.location.href='<?php echo url('RecycleBin/gbookattr_index'); ?>';">
                    ...
                    <!-- <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo url('RecycleBin/proattr_index'); ?>';">
                    </div> -->
                </div>
            </form>
        </div>
                ...
                <table style="width: 100%;">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="">
                                <div class="w150 tc"><a href="<?php echo url('RecycleBin/proattr_index', array('typeid'=>$vo['typeid'])); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="w100 tc">
                            ...
                            <td class="">
                                <div class="w150 tc">
                                    <?php if(is_check_access('RecycleBin@proattr_recovery') == '1'): ?>
                                    <a class="btn blue" href="javascript:void(0);" data-url="<?php echo url('RecycleBin/proattr_recovery'); ?>" data-id="<?php echo $vo['attr_id']; ?>" data-attr_name="<?php echo $vo['attr_name']; ?>" onClick="recovery(this);"><i class="fa fa-trash-o"></i>还原</a>
                                    <?php endif; if(is_check_access('RecycleBin@proattr_del') == '1'): ?>
                                    <a class="btn red" href="javascript:void(0);" data-url="<?php echo url('RecycleBin/proattr_del'); ?>" data-id="<?php echo $vo['attr_id']; ?>" data-attr_name="<?php echo $vo['attr_name']; ?>" onClick="delfun(this);"><i class="fa fa-trash-o"></i>彻底删除</a>
                                    <?php endif; ?>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <?php if(is_check_access('RecycleBin@proattr_recovery') == '1'): ?>
                <div class="fbutton">
                    <a onclick="batch_recovery(this, 'ids');" data-url="<?php echo url('RecycleBin/proattr_recovery'); ?>">
                ...
                <?php endif; if(is_check_access('RecycleBin@proattr_del') == '1'): ?>
                <div class="fbutton">
                    <a onclick="batch_del(this, 'ids');" data-url="<?php echo url('RecycleBin/proattr_del'); ?>">
