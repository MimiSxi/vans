...
<div class="page" style="min-width: auto;box-shadow:none;">
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="searchForm" action="<?php echo url('Custom/index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
                <?php echo (isset($searchform['hidden']) && ($searchform['hidden'] !== '')?$searchform['hidden']:''); ?>
                <input type="hidden" name="channel" value="<?php echo (\think\Request::instance()->param('channel') ?: 0); ?>">
                <div class="sDiv">
                    <!-- 扩展 -->
        ...
        function quick_release()
        {
            ...
            layer.open({
                ...
                success: function(layero, index){
                    ...
                    <div class="sDiv2">
                        <input type="button" class="btn" value="重置" onClick="window.location.href='<?php echo url('Custom/index', array("channel"=>\think\Request::instance()->param('channel'),"typeid"=>\think\Request::instance()->param('typeid'))); ?>';">
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="" style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    ...
                                    <a href="<?php echo url('Custom/edit',array('id'=>$vo['aid'], 'channel'=>\think\Request::instance()->param('channel'))); ?>" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold;<?php endif; ?>"><?php echo $vo['title']; ?></a>
                                    <?php else: ?>
                            ...
                            <td class="">
                                <div class="w100 tc"><a href="<?php echo url('Custom/index', array('typeid'=>$vo['typeid'], 'channel'=>\think\Request::instance()->param('channel'), 'tab'=>3)); ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td>
                                <div class="tc w50">
                            ...
                            <td class="">
                                <div class="w180 tc">
                                    <?php if(is_check_access(CONTROLLER_NAME.'@edit') == '1'): ?>
                                    <a href="<?php echo url('Custom/edit',array('id'=>$vo['aid'], 'channel'=>\think\Request::instance()->param('channel'))); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Custom/del', ['channel'=>\think\Request::instance()->param('channel')]); ?>" data-id="<?php echo $vo['aid']; ?>" data-deltype="pseudo" onClick="delfun(this);"><i class="fa fa-trash-o"></i>删除</a>
                                    <?php endif; ?>
        ...
        <div class="footer-oper">
            ...
            <div class="nav-dropup">
                ...
                <div class="dropdown-menus" style="display:none;">
                    ...
                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                    <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Custom/del', ['channel'=>\think\Request::instance()->param('channel')]); ?>" data-deltype="pseudo"><i class="fa fa-close"></i>删除文档</a>
