<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:30:"./template/pc/view_special.htm";i:1608278125;}*/ ?>
<!DOCTYPE html>
<html>
    <head> 
                ...
                <article class="content">
                    ...
                    <div class="post">
                        ...
                        <section class="article-list">
                            <?php  if(!isset($aid) || empty($aid)) : $aid = "0"; endif; $tag = array (
  'code' => 'default1',
  'id' => 'field',
); $tagSpecnode = new \think\template\taglib\eyou\TagSpecnode; $_result_tmp = $tagSpecnode->getSpecnode($tag, $aid,"","default1","","","0","","100","160","10","on"); if(is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator): $i = 0; $e = 1; $__SPECN_NODE_LIST__ = $_result_tmp["list"]; $__SPECN_NODE_PAGES__ = $_result_tmp["pages"];if( count($__SPECN_NODE_LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__SPECN_NODE_LIST__ as $key=>$field): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                            <article>
                                ...
                                <a href="<?php echo $field['arcurl']; ?>" target="_blank" title="<?php echo $field['title']; ?>" style="float: left; margin-right: 10px"> <img src="<?php echo $field['litpic']; ?>" alt="<?php echo $field['title']; ?>" height="100" /> </a>
                                <?php endif; ?> 
                                <h2><a href="<?php echo $field['arcurl']; ?>" target="_blank"><?php echo $field['title']; ?></a><span><?php echo $field['click']; ?>°C</span></h2>
                                <div class="excerpt">
                                    <p><?php echo $field['seo_description']; ?></p>
                                </div>
                                <div class="meta">
                                    <span class="item"><time><?php echo MyDate('Y-m-d',$field['add_time']); ?></time></span>
                                    <span class="item"><a href="<?php echo $field['typeurl']; ?>" target="_blank"><?php echo $field['typename']; ?></a></span>
                                </div>
                            </article>
